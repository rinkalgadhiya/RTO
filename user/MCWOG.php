...
<nav>
    ...
    <center>
        <h1 class="heading"><b class="head">M</b>otor <b class="head">C</b>ycle <b class="head">W</b>ith <b
                class="head">O</b>ut </b> <b class="head">G</b>ear</h1>
    </center>
    <div class="BGI">
        <img src="mopad.png" height="300px" width="450px">
    </div>
    <form action="MCWOGpro.php" method="post">
        <div class="ip">
            <table>
                <tr>
                    <td>Firstname:</td>
