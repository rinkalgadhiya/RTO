<?php
    ...
    ?>
        ...
        *{
        ...
        <form action='fbupdpro.php' method='POST'><div class='div1'><center><table>
<?php
        $id = $_GET['id'];

        $q = mysqli_query($cn,"select * from feedback where id = '$id' ");
        ...
        while($r = mysqli_fetch_array($q))
        {
            ...
            echo "<tr><td>Rate:</td>";
            echo "<td><input type='text' name='rate' value=".$r[1]."></td></tr>";

            echo "<tr><td>Suggestion:</td>";
            echo "<td><input type='text' name='extra' value=".$r[2]."></td></tr>";

            echo "<tr><td>Email:</td>";
            echo "<td><input type='text' name='email' value=".$r[3]."></td></tr>";
