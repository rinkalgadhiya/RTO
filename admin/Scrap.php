<?php
    include('connect.php');
        ...
        *{
        ...
        </nav><div class='head'>Scrap Vehicle</div>";
        echo "<table>";
        echo "<tr>";
        echo "<th>ID</th>";
        echo "<th>RVSFO</th>";
        ...
        $q = mysqli_query($cn,"select * from reg_scrap_vehicle");
    ...
    while($r = mysqli_fetch_array($q))
    {
        ...
        <tr>
            ...
            <td><center><a class='link' href='scrapupd.php?id=".$r[0]." '>UPDATE</a></center></td>
            <td><center><a class='link' href='scrapdel.php?id=".$r[0]." '>DELETE</a></center></td>
        </tr>";
    }
