<?php
    ...
    ?>
        ...
        *{
        ...
        <form action='scrapupdpro.php' method='POST'><div class='div1'><center><table>
<?php
        $id = $_GET['id'];

        $q = mysqli_query($cn,"select * from reg_scrap_vehicle where id = '$id' ");
        ...
        while($r = mysqli_fetch_array($q))
        {
            ...
            echo "<tr><td>RVSFO:</td>";
            echo "<td><input type='Checkbox' name='RVSFO' value=".$r[1]."></td></tr>";

            echo "<tr><td>Vehicle no:</td>";
            echo "<td><input type='text' name='vno' value=".$r[2]."></td></tr>";

            echo "<tr><td>Adhar no:</td>";
            echo "<td><input type='text' name='ano' value=".$r[3]."></td></tr>";
