<?php
    ...
    ?>
        ...
        *{
        ...
        <form action='RTOregupdpro.php' method='POST'><div class='div1'><center><table>
<?php
        $id = $_GET['id'];

        $q = mysqli_query($cn,"select * from rto_registration where id = '$id' ");
        ...
        while($r = mysqli_fetch_array($q))
        {
            ...
            echo "<td><input type='text' name='rtono' value=".$r[1]."></td></tr>";

            echo "<tr><td>Email:</td>";
            echo "<td><input type='text' name='email' value=".$r[2]."></td></tr>";

            echo "<tr><td>State:</td>";
            echo "<td><input type='text' name='state' value=".$r[3]."></td></tr>";

            echo "<tr><td>City:</td>";
            echo "<td><input  type='text' name='city' value=".$r[4]."></td></tr>";
