<?php
    include('connect.php');
        ...
        *{
        ...
        </nav><div class='head'>RTO Registration</div>";
        echo "<table>";
        echo "<tr>";
        echo "<th>ID</th>";
        ...
        $q = mysqli_query($cn,"select * from rto_registration");
    ...
    while($r = mysqli_fetch_array($q))
    {
        ...
        <tr>
            ...
            <td><center><a class='link' href='RTOregupd.php?id=".$r[0]." '>UPDATE</a></center></td>
            <td><center><a class='link' href='RTOregdel.php?id=".$r[0]." '>DELETE</a></center></td>
        </tr>";
    }
