...
<?php
        $q = mysqli_query($cn,"select * from lmv1");
    ...
    while($r = mysqli_fetch_array($q))
    {
        ...
        <tr>
            ...
            <td><center><a class='link' href='lmvupd.php?id=".$r[0]." '>UPDATE</a></center></td>
            <td><center><a class='link' href='lmvdel.php?id=".$r[0]." '>DELETE</a></center></td>
        </tr>";
    }
