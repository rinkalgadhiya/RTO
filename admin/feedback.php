<?php
    ...
    *{
    ...
    </nav><div class='head'>Feedback</div>";
        echo "<table>";
        echo "<tr>";
        echo "<th>ID</th>";
        echo "<th>Rate</th>";
    ...
    while($r = mysqli_fetch_array($q))
    {
        ...
        <tr>
            ...
            <td><center><a class='link' href='fbupd.php?id=".$r[0]." '>UPDATE</a></center></td>
            <td><center><a class='link' href='fbdel.php?id=".$r[0]." '>DELETE</a></center></td>
        </tr>";
    }
